...
public class FavoriteBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.rino.ekky.mystackwidget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.rino.ekky.mystackwidget.EXTRA_ITEM";
